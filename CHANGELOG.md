...
- *(obligation)* class-bounded discharge scope ([#260](https://github.com/fmsouza/lanekeep/pull/260))
- *(obligation)* component-bounded discharge scope ([#261](https://github.com/fmsouza/lanekeep/pull/261))
- *(obligation)* correlate @key by value origin (keyBy: 'binding') ([#264](https://github.com/fmsouza/lanekeep/pull/264))
