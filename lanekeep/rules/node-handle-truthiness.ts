...
export default defineRule({
  ...
  // `ctx.` admits nearly every rule file, so it buys little; §7.1 requires a gate to
  // over-approximate its own rule's query, and an over-broad one costs a parse rather than a
  // wrong answer.
