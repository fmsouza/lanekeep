...
export default defineRule({
  ...
  // `ctx.` admits nearly every rule file, so it buys little; §7.1's safe way to keep a gate
  // neutral is to keep it wider than the query it guards, and an over-broad one costs a parse
