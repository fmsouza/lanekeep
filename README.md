...
| [`docs/type-aware-rules.md`](docs/type-aware-rules.md) | Rules that ask a node's type: the oracle, the providers behind it, and what the reference corpus measured |
