...
WebAssembly component, which is how four of the fourteen built-ins ship — two written in Rust
and two written in Go; the other ten run as QuickJS modules, three of them checking five of
